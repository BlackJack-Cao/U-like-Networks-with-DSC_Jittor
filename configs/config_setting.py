...
class setting_config:
    ...
    work_dir = '/workspace/UNet-TTT/results/'+ network + '_' + datasets + '_' + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
    # work_dir = '/workspace/UNet-TTT/results/unet_isic17_Thursday_10_July_2025_03h_46m_10s'
    print_interval = 20
    val_interval = 30
    save_interval = 5
    threshold = 0.5

    # Jittor uses different transform system
    train_transformer = [
